...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x3d3c55; // 'cnoTe' address prefix
...
const uint64_t MINIMUM_FEE                                   = UINT64_C(1000000000); // pow(10, 9)
...
const char     CRYPTONOTE_NAME[]                             = "cryptonotecoin";
